...
downstream = {'MSD','Diffusion','TurningBehavior','StateClassification'};
...
stages = { ...
    ...
    'TurningBehavior', @SPT_Kinematics_TurningBehavior, ...
...
names = {'Step','Trajectory','Confinement','TurningAngle', ...
    'TrajectorySamples','MSD','Diffusion','TurningBehavior', ...
    'StateClassification'};
sources = { ...
...
propagated = {'TrajectorySamples','MSD','Diffusion', ...
    'TurningBehavior','StateClassification'};
...
files = { ...
    ...
    'SPT_Kinematics_TurningBehavior.m'; ...
...
verifyEqual(testCase, ...
    Kinematics.TurningBehavior.Summary.nTrajectories, 2);
verifyEqual(testCase, ...
